...
A half-second hold on a to-do row also **lifts it for a drag**: move the finger and drop it in the gap between two rows, or onto a group heading, a calendar day or a week-planner column, exactly as a mouse drag does on desktop. Releasing over anything else cancels, and a hold you release without moving still opens the menu.
