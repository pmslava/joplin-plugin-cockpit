 ...
 *  - Markdown, Split and Viewer-only layouts all work: Joplin's CM6 component always renders its editor and only toggles classes.                   *
 ...
 *                                                                                                                                                  *
 * When anything is missing (no note id, a disabled bell, an unexpected DOM) the event is left ALONE, so the worst case is Joplin's own picker.      *
 ***************************************************************************************************************************************************/
